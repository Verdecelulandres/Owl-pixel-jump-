...
const regUsrErrMsg = document.getElementsByClassName("error-msg")[1];
const regPwdErrMsg = document.getElementsByClassName("error-msg")[2];
const regRePwdErrMsg = document.getElementsByClassName("error-msg")[3];
